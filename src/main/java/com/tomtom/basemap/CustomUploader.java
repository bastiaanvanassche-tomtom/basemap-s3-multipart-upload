...
public class CustomUploader implements Uploader {
    private final Logger LOGGER = LoggerFactory.getLogger(CustomUploader.class);

        public void multipartUploadWithS3Client(String filePath, String bucketName, String key, String region, long chunkSize) {
